        ...
        * */
        ...
        try {
            ...
            * */
            ...
            Server.MessageQueue.put(new msg_ChangeChargingMode(new Car(true, -1, -1, 0), new CompletableFuture<>()));
            Server.MessageQueue.put(new msg_ChangeChargingMode(new Car(false, -1, -1, 6), new CompletableFuture<>()));
            //改变4和9号的。预取请求成功
            Server.MessageQueue.put(new msg_ChangeChargingMode(new Car(true, -1, -1, 4), new CompletableFuture<>()));
            Server.MessageQueue.put(new msg_ChangeChargingMode(new Car(false, -1, -1, 9), new CompletableFuture<>()));
            server.run();
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
